...
import type { TrendingFacetsClassNames } from 'instantsearch-ui-components';
import type { TrendingFacetsProps } from 'instantsearch-ui-components';
...
declare abstract class AbstractChat<TUIMessage extends UIMessage> {
    ...
    private shouldRepairToolInput?;
    private activeResponse;
    private jobExecutor;
    constructor({ generateId, id, transport, state, onError, onToolCall, onFinish, onData, sendAutomaticallyWhen, shouldRepairToolInput, }: Omit<ChatInit<TUIMessage>, 'messages'> & {
...
declare type AutocompleteTranslations = {
...
declare type AutocompleteWidgetParams<TItem extends BaseHit> = {
    /**
     * CSS Selector or HTMLElement to insert the widget.
     */
    container: string | HTMLElement;
...
declare function chatGreeting(options?: Pick<ChatGreetingProps, 'banner' | 'translations' | 'classNames'>): (props: ChatGreetingProps) => h.JSX.Element;
...
declare function chatInlineLayout(): {
    (props: ChatLayoutTemplateData): h.JSX.Element;
    $$inlineLayout: true;
};

declare type ChatLayoutTemplateData = Omit<ChatLayoutOwnProps, 'headerComponent' | 'messagesComponent' | 'promptComponent'> & {
    templates: {
        header: () => JSX.Element;
...
declare function chatMessageLoader(props?: ChatMessageLoaderProps): h.JSX.Element;
...
declare function chatOverlayLayout(): (props: ChatLayoutTemplateData) => h.JSX.Element;
...
declare function chatSidePanelLayout(options?: Pick<ChatSidePanelLayoutProps, 'parentElement'>): (props: ChatLayoutTemplateData) => h.JSX.Element;
...
declare interface ChatTransport<UI_MESSAGE extends UIMessage> {
    sendMessages: (options: {
        ...
        messageId?: string;
    } & ChatRequestOptions) => Promise<ReadableStream<InferUIMessageChunk<UI_MESSAGE>>>;
    reconnectToStream: (options: {
        chatId: string;
    } & ChatRequestOptions) => Promise<ReadableStream<InferUIMessageChunk<UI_MESSAGE>> | null>;
}
...
declare function chatTrigger(widgetParams: ChatTriggerWidgetParams): {
    ...
    getWidgetRenderState: (renderOptions: InitOptions | RenderOptions) => Expand<WidgetRenderState<ChatTriggerRenderState, ChatTriggerConnectorParams & object>>;
    getRenderState: (renderState: {
        ...
        feeds?: FeedsRenderState | undefined;
        ...
        chatTrigger?: WidgetRenderState<ChatTriggerRenderState, ChatTriggerConnectorParams> | undefined;
    }, renderOptions: InitOptions | RenderOptions) => IndexRenderState & {
        chatTrigger: WidgetRenderState<ChatTriggerRenderState, ChatTriggerConnectorParams>;
    };
    dependsOn?: "search";
    ...
    getWidgetRenderState: ((renderOptions: InitOptions | RenderOptions) => Expand<WidgetRenderState<ChatTriggerRenderState, ChatTriggerConnectorParams & object>>) & ((renderOptions: InitOptions | ({
    ...
    })) => Expand<WidgetRenderState<ChatTriggerRenderState, ChatTriggerConnectorParams & object>>);
    getRenderState: ((renderState: {
        answers?: WidgetRenderState<AnswersRenderState, AnswersConnectorParams> | undefined;
        autocomplete?: WidgetRenderState<AutocompleteRenderState, AutocompleteConnectorParams> | undefined;
        breadcrumb?: {
...
declare type ChatTriggerConnector = Connector<ChatTriggerWidgetDescription, ChatTriggerConnectorParams>;
 ...
 */
declare type ChatTriggerConnectorParams = Record<string, never>;

declare type ChatTriggerCSSClasses = Partial<{
    /**
...
declare type ChatTriggerRenderState = {
    /**
...
declare type ChatTriggerTemplates = Partial<{
    /**
...
declare type ChatTriggerWidgetDescription = {
    $$type: 'ais.chatTrigger';
...
declare type ChatTriggerWidgetParams = {
    /**
     * CSS Selector or HTMLElement to insert the widget.
     */
    container: string | HTMLElement;
...
declare type ClientSideToolTemplateData = ClientSideToolComponentProps;

declare type ComponentCSSClasses<TCSSClasses> = Required<{
    [className in keyof TCSSClasses]: string;
}>;

declare type CompositionFeedResult = NonNullable<SearchResults['_rawResults']>[number] & {
    feedID: string;
};
...
declare const connectChatTrigger: ChatTriggerConnector;
...
declare const connectFeeds: FeedsConnector;
...
declare namespace connectors {
    export {
        ...
        _default_4 as connectTrendingFacets,
        _default_5 as connectTrendingItems,
        connectBreadcrumb,
        _default_6 as connectGeoSearch,
        connectPoweredBy,
        connectConfigure,
        connectAutocomplete,
        connectQueryRules,
        connectVoiceSearch,
        connectRelevantSort,
        _default_7 as connectFrequentlyBoughtTogether,
        _default_8 as connectLookingSimilar,
        _default_9 as connectChat,
        connectFeeds,
        connectChatTrigger,
 ...
 */
declare const _default_10: <THit extends GeoHit = GeoHit>(widgetParams: GeoSearchWidgetParams<THit> & GeoSearchConnectorParams<THit>) => {
...
declare const _default_11: <THit extends NonNullable<object> = BaseHit>(widgetParams: HitsWidgetParams<THit> & HitsConnectorParams<THit>) => {
    $$widgetType: "ais.hits";
    $$type: "ais.hits";
    init(initOptions: InitOptions): void;
    render(renderOptions: RenderOptions): void;
...
declare const _default_12: <THit extends NonNullable<object> = BaseHit>(widgetParams: InfiniteHitsWidgetParams<THit> & InfiniteHitsConnectorParams<THit>) => {
...
declare const _default_13: PlacesWidget;

declare const _default_14: <THit extends NonNullable<object> = BaseHit>(widgetParams: RelatedProductsWidgetParams<THit> & RelatedProductsConnectorParams<THit>) => {
...
declare const _default_15: (widgetParams: TrendingFacetsWidgetParams & TrendingFacetsConnectorParams) => {
    ...
    getWidgetRenderState({ results, helper, instantSearchInstance }: InitOptions | RenderOptions | ({
        ...
        widgetParams: Partial<TrendingFacetsWidgetParams> & TrendingFacetsConnectorParams;
    };
    dispose({ recommendState }: DisposeOptions): RecommendParameters;
    getWidgetParameters(state: RecommendParameters): RecommendParameters;
};

declare const _default_16: <THit extends NonNullable<object> = BaseHit>(widgetParams: TrendingItemsWidgetParams<THit> & TrendingItemsConnectorParams<THit>) => {
...
declare const _default_17: <THit extends NonNullable<object> = BaseHit>(widgetParams: FrequentlyBoughtTogetherWidgetParams<THit> & FrequentlyBoughtTogetherConnectorParams<THit>) => {
...
declare const _default_18: <THit extends NonNullable<object> = BaseHit>(widgetParams: LookingSimilarWidgetParams<THit> & LookingSimilarConnectorParams<THit>) => {
...
declare const _default_19: <THit extends RecordWithObjectID = RecordWithObjectID>(widgetParams: ChatWidgetParams<THit> & ChatConnectorParams) => {
    $$widgetType: "ais.chat";
    $$type: "ais.chat";
    init(initOptions: InitOptions): void;
    render(renderOptions: RenderOptions): void;
    ...
    getWidgetRenderState(renderOptions: InitOptions | RenderOptions): {
        ...
        onClearTransitionEnd: () => void;
        tools: ClientSideTools;
        sendChatMessageFeedback: ((messageId: string, vote: 0 | 1) => void) | undefined;
        feedbackState: Record<string, 0 | 1 | "sending">;
 ...
 * @deprecated Filter suggestions are deprecated and will be removed in a future major version.
 */
declare const _default_20: (widgetParams: FilterSuggestionsWidgetParams & FilterSuggestionsConnectorParams) => {
...
declare const _default_4: <TWidgetParams extends UnknownWidgetParams>(renderFn: Renderer<TrendingFacetsRenderState, TWidgetParams & TrendingFacetsConnectorParams>, unmountFn?: Unmounter) => (widgetParams: TWidgetParams & TrendingFacetsConnectorParams) => {
    dependsOn: "recommend";
    $$type: "ais.trendingFacets";
    init(initOptions: InitOptions): void;
    render(renderOptions: RenderOptions): void;
    ...
    getWidgetRenderState({ results, helper, instantSearchInstance }: InitOptions | RenderOptions | ({
        ...
        items: TrendingFacetItem[];
        widgetParams: TWidgetParams & TrendingFacetsConnectorParams;
    };
    dispose({ recommendState }: DisposeOptions): RecommendParameters;
    getWidgetParameters(state: RecommendParameters): RecommendParameters;
};

declare const _default_5: <TWidgetParams extends UnknownWidgetParams>(renderFn: Renderer<TrendingItemsRenderState, TWidgetParams & TrendingItemsConnectorParams>, unmountFn?: Unmounter) => <THit extends NonNullable<object> = BaseHit>(widgetParams: TWidgetParams & TrendingItemsConnectorParams<THit>) => {
    dependsOn: "recommend";
    $$type: "ais.trendingItems";
    init(initOptions: InitOptions): void;
    render(renderOptions: RenderOptions): void;
 ...
 * Currently, the feature is not compatible with multiple values in the _geoloc attribute.
 */
declare const _default_6: <TWidgetParams extends UnknownWidgetParams>(renderFn: Renderer<GeoSearchRenderState, TWidgetParams & GeoSearchConnectorParams>, unmountFn?: Unmounter) => <THit extends GeoHit = GeoHit>(widgetParams: TWidgetParams & GeoSearchConnectorParams<THit>) => {
    $$type: "ais.geoSearch";
    init(initArgs: InitOptions): void;
    render(renderArgs: RenderOptions): void;
    getWidgetRenderState(renderOptions: InitOptions | RenderOptions): {
...
declare const _default_8: <TWidgetParams extends UnknownWidgetParams>(renderFn: Renderer<LookingSimilarRenderState, TWidgetParams & LookingSimilarConnectorParams>, unmountFn?: Unmounter) => <THit extends NonNullable<object> = BaseHit>(widgetParams: TWidgetParams & LookingSimilarConnectorParams<THit>) => {
    dependsOn: "recommend";
    $$type: "ais.lookingSimilar";
    init(initOptions: InitOptions): void;
    render(renderOptions: RenderOptions): void;
...
declare const _default_9: <TWidgetParams extends UnknownWidgetParams>(renderFn: Renderer<ChatRenderState, TWidgetParams & ChatConnectorParams>, unmountFn?: Unmounter) => <TUiMessage extends UIMessage = UIMessage<unknown, UIDataTypes, UITools>>(widgetParams: TWidgetParams & ChatConnectorParams<TUiMessage>) => {
    $$type: "ais.chat";
    init(initOptions: InitOptions): void;
    render(renderOptions: RenderOptions): void;
    getRenderState(renderState: {
...
declare class DefaultChatTransport<TUIMessage extends UIMessage> extends HttpChatTransport<TUIMessage> {
    ...
    protected processResponseStream(stream: ReadableStream<Uint8Array>): ReadableStream<InferUIMessageChunk<TUIMessage>>;
}
...
declare function EXPERIMENTAL_autocomplete<TItem extends BaseHit = BaseHit>(widgetParams: AutocompleteWidgetParams<TItem> & AutocompleteConnectorParams): (IndexWidget<UiState> | Widget<SearchBoxWidgetDescription & {
widgetParams: SearchBoxConnectorParams & object;
}>)[];
...
declare const feeds: FeedsWidget;

declare type FeedsConnector = Connector<FeedsWidgetDescription, FeedsConnectorParams>;

declare type FeedsConnectorParams = {
    /**
...
declare type FeedsRenderState = {
    feedIDs: string[];
};

declare type FeedsWidget = WidgetFactory<FeedsWidgetDescription & {
    $$widgetType: 'ais.feeds';
}, Omit<FeedsConnectorParams, 'transformFeeds'>, FeedsWidgetParams & Pick<FeedsConnectorParams, 'transformFeeds'>>;

declare type FeedsWidgetDescription = {
    $$type: 'ais.feeds';
...
declare type FeedsWidgetParams = {
    /**
     * CSS Selector or HTMLElement to insert the widget.
     */
    container: string | HTMLElement;
     ...
     */
    widgets: (container: HTMLElement, feedID: string) => Array<Widget> | null | undefined;
};
...
declare abstract class HttpChatTransport<TUIMessage extends UIMessage> implements ChatTransport<TUIMessage> {
    ...
    sendMessages({ abortSignal, chatId, messages, requestMetadata, trigger, messageId, headers: requestHeaders, body: requestBody, }: Parameters<ChatTransport<TUIMessage>['sendMessages']>[0]): Promise<ReadableStream<InferUIMessageChunk<TUIMessage>>>;
    reconnectToStream({ chatId, headers: requestHeaders, body: requestBody, }: Parameters<ChatTransport<TUIMessage>['reconnectToStream']>[0]): Promise<ReadableStream<InferUIMessageChunk<TUIMessage>> | null>;
    protected abstract processResponseStream(stream: ReadableStream<Uint8Array>): ReadableStream<InferUIMessageChunk<TUIMessage>>;
}
...
declare type IndexWidgetType = (typeof indexWidgetTypes)[number];

declare const indexWidgetTypes: readonly ["ais.index", "ais.feedContainer"];

declare type InferUIMessageChunk<T extends UIMessage> = UIMessageChunk<InferUIMessageMetadata<T>, InferUIMessageData<T>, InferUIMessageTools<T>>;
...
declare type InferUIMessageTools<T extends UIMessage> = T extends UIMessage<unknown, any, infer TOOLS> ? TOOLS : UITools;
...
declare class InstantSearch<TUiState extends UiState = UiState, TRouteState = TUiState> extends EventEmitter {
     ...
     */
    addWidgets(widgets: Array<Widget | IndexWidget | Array<IndexWidget | Widget>>): this;
    /**
...
declare type SearchBoxComponentCSSClasses = ComponentCSSClasses<Omit<SearchBoxCSSClasses, 'aiModeButton' | 'aiModeIcon' | 'aiModeLabel'>> & {
    aiModeButton?: string;
    aiModeIcon?: string;
    aiModeLabel?: string;
};
...
declare type ToolUIMessageChunk<TOOLS extends UITools> = ValueOf<{
 ...
 */
declare type TrendingFacetItem = {
...
declare type TrendingFacetsConnectorParams = {
    /**
     ...
     * Function to transform the items passed to the templates.
     */
    transformItems?: TransformItems<TrendingFacetItem, {
        results: RecommendResponse<TrendingFacetItem>;
    }>;
};

declare type TrendingFacetsCSSClasses = Partial<TrendingFacetsClassNames>;

declare type TrendingFacetsRenderState = {
    /**
...
declare type TrendingFacetsTemplates = Partial<{
    /**
     * Template to use when there are no results.
     */
     ...
     * Template to use for the header of the widget.
     */
    header: Template<Pick<Parameters<NonNullable<TrendingFacetsProps['headerComponent']>>[0], 'items'> & {
...
declare type TrendingFacetsWidgetParams = {
    /**
     * CSS selector or `HTMLElement` to insert the widget into.
     */
    container: string | HTMLElement;
...
declare type UIMessageChunk<METADATA = unknown, DATA_TYPES extends UIDataTypes = UIDataTypes, TOOLS extends UITools = UITools> = {
    type: 'text-start';
    id: string;
    providerMetadata?: ProviderMetadata;
} | {
...
declare namespace widgets {
    export {
        ...
        currentRefinements,
        feeds,
        _default_10 as geoSearch,
        hierarchicalMenu,
        _default_11 as hits,
        hitsPerPage,
        index,
        IndexWidget,
        _default_12 as infiniteHits,
        menu,
        menuSelect,
        numericMenu,
        pagination,
        panel,
        _default_13 as places,
        poweredBy,
        queryRuleContext,
        queryRuleCustomData,
        _default_14 as relatedProducts,
        rangeInput,
        rangeSlider,
        ratingMenu,
        refinementList,
        ...
        stats,
        toggleRefinement,
        _default_15 as trendingFacets,
        _default_16 as trendingItems,
        voiceSearch,
        _default_17 as frequentlyBoughtTogether,
        _default_18 as lookingSimilar,
        _default_19 as chat,
        chatTrigger,
        _default_20 as filterSuggestions
    }
}
