...
.fancybox__toolbar button[title="翻转 X"],
.fancybox__toolbar button[title="Flip X"],
.fancybox__toolbar button[title="翻转 Y"],
.fancybox__toolbar button[title="Flip Y"],
.fancybox__toolbar button[title="重置"],
.fancybox__toolbar button[title="Reset"] {
